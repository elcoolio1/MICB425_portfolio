...
* RMarkdown Pretty PDF Challenge
    ...
    + Comments: 
* ggplot
    + Completion status: Couldn't get some packages to work, had to give up
    + Comments: 
...
####Prompt
_"Microbial life can easily live without us; we, however, cannot survive without the global catalysis and environmental transformations it provides." Do you agree or disagree with this statement? Answer the question using specific reference to your reading, discussions and content from evidence worksheets and problem sets.”_

####Response

```{r child = "Writing_assign_1.Rmd"}
...
Berna _et al._ 2012. Microstratigraphic evidence of in situ fire in the Acheulean strata of Wonderwerk Cave, Norther Cape province, South Africa. PNAS. 109(20)E1215-E1220. [DOI:10.1073/pnas.1117620109](http://www.pnas.org/content/109/20/E1215)

NOAA. 2018. [Recent Monthly Mean CO2 at Mauna Loa.](https://www.esrl.noaa.gov/gmd/ccgg/trends/)

Vitousek _et al._ 1997. Human Domination of Earth's Ecosystems. Science. 277(5325): 494-499. [DOI: 10.1126/science.277.5325.494](http://science.sciencemag.org/content/277/5325/494.full)

Vlachogianni and Valavanidis. 2013. Energy and Environmental Impact on the Biosphere Energy Flow, Storage and Conversion in Human Civilization. [Science and Education Publishing.](http://pubs.sciepub.com/education/1/3/2/index.html#Figure1)

Chien and Karamcheti. 2013. Moore's Law: The First Ending and a New Beginning. Computer. 46(12):48-53. [DOI: 10.1109/MC.2013.431](https://dl.acm.org/citation.cfm?id=2635529)
...
In 2002, values up to [500000](http://www.pnas.org/content/99/16/10234) were discussed.in 2016 values of [millions](http://mbio.asm.org/content/7/4/e00999-16.full) to [trillions](http://www.pnas.org/content/113/21/5970?ijkey=ff5bbc93c54540611ec24a932493181f098ae1bc&keytype2=tf_ipsecsha) were presented. Only [20%](https://www.nature.com/articles/nature08656) of prokaryotes are represented by cultured species.
...
Thousands available just from [EBI](https://www.ebi.ac.uk/metagenomics/projects) and thousands more from hundreds of other sources. The main biomes sequenced are [soil, human digestive tract, marine, and freshwater](https://www.ebi.ac.uk/metagenomics/;jsessionid=A9198E139B43A203F89D37B8BD1D9146), but metagenomics projects exist for almost every conceivable niche environment.
...
Metagenome databases: [EBI](https://www.ebi.ac.uk/metagenomics/;jsessionid=A9198E139B43A203F89D37B8BD1D9146),[NCBI](https://www.ncbi.nlm.nih.gov/bioproject)

Marker gene databases: [SILVA](https://www.arb-silva.de/),[Greengenes](http://greengenes.lbl.gov/Download/)

Tools: [RDP](https://rdp.cme.msu.edu/), [BLAST](https://blast.ncbi.nlm.nih.gov/Blast.cgi?PAGE_TYPE=BlastSearch)
...
Third gen sequencing. Single molecule sequencing can sequence whole genomes without the need to bin or assemble genomes. Some examples are [Oxford Nanopore](https://nanoporetech.com/) and [PacBio](https://www.pacb.com/).
...
![Diversity values](Candy_diversity.png)
...
####Prompt
_“Discuss the challenges involved in defining a microbial species and how HGT complicates matters, especially in the context of the evolution and phylogenetic distribution of microbial metabolic pathways.  Can you comment on how HGT influences the maintenance of global biogeochemical cycles through time?  Finally, do you think it is necessary to have a clear definition of a microbial species?  Why or why not?”_

####Response

```{r child = "Writing_assign_3.Rmd"}
...
Kim _et al._ 2014. Towards a taxonomic coherence between average nucleotide identity and 16S rRNA gene sequence similarity for species demarcation of prokaryotes. Int J Syst Evol Microbiol. 64(Pt 2):346-51. [DOI: 10.1099/ijs.0.059774-0](https://www.ncbi.nlm.nih.gov/pubmed/24505072)

Falkowski PG, Fenchel T, Delong EF. 2008. The microbial engines that drive Earth's biogeochemical cycles. Science. 320(1034). [DOI:10.1126/science.1153213](https://www.ncbi.nlm.nih.gov/pubmed/18497287)

Giovannoni SJ. 2017. SAR11 bacteria: The most abundant plankton in the oceans. Ann Rev Mar Sci. 9(1):231-255. [DOI: 10.1146/annurev-marine-010814-015934](https://www.ncbi.nlm.nih.gov/pubmed/27687974)

Martinez _et al._ 2007. Proteorhodopsin photosystem gene expression enables photophosphorylation in a heterologous host. Proc Natl Acad Sci USA. 104(13):5590-5595. [DOI:10.1073/pnas.0611470104](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1838496/)

Wooley, Godzik, Friedberg. 2010. A primer on metagenomics. Comput Biol. 6(2):e1000667. [DOI:10.1371/journal.pcbi.1000667](http://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1000667)

Kunin _et al._ 2010. Wrinkles in the rare biosphere: pyrosequencing errors can lead to artificial inflation of diversity estimates. Environ Microbiol. 12(1):118-23. [DOI: 10.1111/j.1462-2920.2009.02051](https://www.ncbi.nlm.nih.gov/pubmed/19725865)

Morris, Lenski, Zinser. 2012. The black queen hypothesis: evolution of dependencies through adaptive gene loss. 3(2):e00036-12. [DOI:10.1128/mBio.00036-12](http://mbio.asm.org/content/3/2/e00036-12.abstract)
